        ...
        <div class="inner">
            ...
            <div>
                <?php echo htmlspecialchars(format_event(
                    new DateTimeImmutable('2026-09-16 14:15', new DateTimeZone('Europe/Zurich')),
                    new DateTimeImmutable('2026-09-16 16:00', new DateTimeZone('Europe/Zurich')),
                    date: 'weekday',
                )); ?>
            </div>
            ...
            <a class="right" target="_blank"
                href="https://moodle-app2.let.ethz.ch/course/view.php?id=29124">
                <?php echo htmlspecialchars($t['moodle']); ?>
            </a>
            <a class="right" target="_blank"
                href="https://gitlab.inf.ethz.ch/COURSE-SPCA2026">
                <?php echo htmlspecialchars($t['gitlab']); ?>
            </a>
            <a class="right" target="_blank"
                href="https://expert.ethz.ch/enrolled/AS26/spca/exercises">
