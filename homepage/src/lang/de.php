...
return [
    'pages' => [
        ...
        'teaching' => [
            ...
            'spca26' => [
                ...
                'week1' => [
                    'title' => 'Woche 1',
                    'h1' => 'SPCA HS26 – Woche 1',
                    'topics_content' => [
                        'Administrative Informationen',
                        'Einführung in Linux, Git & C',
                        'Umgebung vorbereiten',
                        'Vorschau Aufgabe 1 (Data Lab)',
                    ],
                    'time' => 'Zeit',
                    'room' => 'Raum',
                    'topics' => 'Themen',
                    'exercise' => 'Aktuelle Aufgabe',
                ],
                'week2' => [
                    'title' => 'Woche 2',
                    'h1' => 'SPCA HS26 – Woche 2',
                    'topics_content' => [
                        'Struktur von .c- und .h- Dateien',
                        'Make und Makefiles',
                        'gcc-Flags',
                        'Tricks & Beispiele für Aufgabe 1',
                    ],
                    'time' => 'Zeit',
                    'room' => 'Raum',
                    'topics' => 'Themen',
    ...
    'components' => [
        ...
        'file-collection' => [
            'modified' => 'Geändert: ',
            'public_label' => 'Diese Datei öffentlich machen',
            'upload_button' => 'Hochladen',
            'link_name' => 'Name des Links',
            'link_url' => 'URL',
            'public_label_link' => 'Diesen Link öffentlich machen',
            'link_submit_button' => 'Hinzufügen',
        ],
        'page-overview' => [
            'topics' => 'Themen',
            'files' => 'Dokumente',
