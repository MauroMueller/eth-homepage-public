 ...
 * 
 *  $page = [
 *      // Flag to show anything at all for this page (defaults to true, exits
 ...
 * 
 *      // Path to the current page's directory (default place for the page
 *      // content)
 *      'path' => SRC_DIR . '/pages/somepage',
 *      
 *      // Path to the php file with the contents for this page (set by default
 *      // using path unless specified)
...
if (isset($page['show_page']) && $page['show_page'] == false) exit;

// Current page
$current_page = $page['current_page'];

// Content path
$content_path = $page['path'] . '/_content.php';
...
if (!isset($page['css_default']) || $page['css_default']) {
    App::asset_registry()->add_external_css(
        'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/7.0.0/css/all.min.css',
    );
    App::asset_registry()->add_css([
        'colors/darkmode.css',
        'colors/lightmode.css',
        'style.css',
    ]);
}
